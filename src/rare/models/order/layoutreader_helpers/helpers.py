# Copyright (c) 2024 Hantian Pang.
#
# Vendored verbatim from FreeOCR-AI/layoutreader, file `v3/helpers.py`:
#     https://github.com/FreeOCR-AI/layoutreader
#
# Licensed under the Creative Commons Attribution-NonCommercial-ShareAlike
# 4.0 International License (CC BY-NC-SA 4.0); see
# licenses/LICENSE-LAYOUTREADER for the full text, or
