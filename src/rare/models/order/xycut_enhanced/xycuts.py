...
# only the relative-import paths were rewritten so the module is
# self-contained inside this vendored package. Algorithm code is unchanged.
...
from .support import calculate_overlap_ratio, calculate_projection_overlap_ratio
from .utils import (
