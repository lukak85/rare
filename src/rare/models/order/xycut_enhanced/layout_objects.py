...
# verbatim copy of paddlex/inference/pipelines/layout_parsing/layout_objects.py;
# only the helper-utilities import was redirected to the cherry-picked
# .support module so the package is self-contained. Class bodies unchanged.
