...
class ClaudeBackend:
    ...
    def __init__(self, config: dict | None = None):
        ...
        model_name = config.get("model", 'claude-opus-4-8')

        if api_key is None:
            raise ValueError("API key must be provided for ClaudeBackend.")
        if base_url is None:
            raise ValueError("Base URL must be provided for ClaudeBackend.")
                        ...
                        "messages": [
                            {
                                ...
                                "content": [
                                    ...
                                    {"type": "text", "text": omnidocbench_pdf_prompt()},
                                ],
                            }
                        ],
                    },
